...
A sample observation of the cleaned data is shown in @tbl-1a and @tbl-1b This table plots the variables of interest for our analysis. It can be seen that most observations are generally not biased to more than one group. Also, due to the categorical nature of the data, this is the best 'summary statistic' that can be shown, although other displays of the data that show all observations are plotted in the @sec-data-analysis-and-plots section. This shows us that every variable of interest is documented rather nicely for analysis.
